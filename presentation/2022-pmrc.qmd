...
<p class="text-center"><a class="btn btn-info btn-lg" target="_blank" href="https://cbgoodman.github.io/pmrc22-presentation/goodman-carroll-pmrc-2022.html">{{< fa arrow-up-right-from-square >}} &ensp;View all slides in new window</a> <a class="btn btn-info btn-lg" target="_blank" href="https://github.com/cbgoodman/pmrc22-presentation/blob/main/goodman-carroll-pmrc-2022.pdf" role="button">{{< fa file-pdf >}} &ensp;Download PDF of all slides</a></p>
