...
<p class="text-center"><a class="btn btn-info btn-lg" target="_blank" href="https://cbgoodman.github.io/spsa2025-presentation/goodman-leland-spsa-2025.html">View all slides in new window&nbsp;&nbsp;&nbsp;{{< bi box-arrow-up-right >}}</a> <a class="btn btn-info btn-lg" target="_blank" href="https://github.com/cbgoodman/spsa2025-presentation/blob/main/goodman_leland_spsa_2025.pdf" role="button">Download PDF of all slides&nbsp;&nbsp;&nbsp;{{< bi download >}}</a></p>
